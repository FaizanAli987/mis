...
function OurMission() {
  return (
    <>
      <Header />
      <SectionBanner
        imglink="https://images-eu.digistormhosting.com."
        link1="About Us"
        link2="Our Mission"
      />
          ...
          <div class="columns is-centered">
            <div class="column is-10-desktop is-10-tablet is-12-mobile">
              <div class="content has-text-centered">
                <h1>BBIS MISSION AND GUIDING STATEMENTS
</h1>
                <p class="text-body">
                  Ideally located in a forested area on the southwest border of
                  Berlin, our spacious and peaceful 360,000 sqm campus is the
                  ideal setting for growth and discovery.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="columns is-centered">
            <div class="column is-8-desktop is-10-tablet is-12-mobile">
              <div class="content">
                ...
                <ul>
                  <li>
                    Large classrooms in both the Primary and Secondary Schools
                  </li>
                  <li>Modern science labs</li>
                  <li>Fully networked computer labs</li>
                  <li>Art studios</li>
                  <li>Music classrooms and practice rooms</li>
                  <li>A multi-purpose room</li>
                  <li>A performance and exhibition space</li>
                  <li>A study room for students in Grades 11 and 12</li>
                  <li>Faculty and student lounges</li>
                  <li>A purpose-built design/technology area</li>
                  <li>Primary School library</li>
                  <li>
                    A learning hub, library, media centre and common room with
                    direct access to the outdoor area for Secondary School
                    students
                  </li>
                </ul>
              </div>
