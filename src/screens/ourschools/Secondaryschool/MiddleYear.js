...
function MiddleYear() {
  return (
    <>
      <Header />
      <SectionBanner
        imglink="https://images-eu.digistormhosting.com."
        link1="SecondarySchool"
        link2="MiddleYear"
      />
          ...
          <div class="columns is-centered">
            <div class="column is-10-desktop is-10-tablet is-12-mobile">
              <div class="content has-text-centered">
                <h1>TECHNOLOGY AT BBIS</h1>
                <p class="text-body">
                  Supporting our students to become responsible digital
                  citizens, with a focus on creativity, collaboration and
                  innovation.
                </p>
              </div>
            </div>
            ...
            <div class="column is-8-desktop is-10-tablet is-12-mobile">
              <div class="content">
                <p>
                  ...
                  understand its potential risks and ethical import StudentLeadership from './StudentLeadership';
considerations.import EarlyEducation from './EarlyEducation';
import LowerGrades from './LowerGrades';
import HigherGrades from './HigherGrades';
import MandBoard from './../../about/MandBoard';
import MiddleYear from './MiddleYear';
